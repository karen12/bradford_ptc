...
if(!empty($_POST)) {
        ...
        if($valid) {
            ...
            $sql = "UPDATE institucion SET nombre_ins = ?, tel_ins = ?, director_ins = ?, correo_ins = ?, objetivo_ins = ?, mision_ins = ?, vision_ins = ?, principios_ins = ?, director_ins = ?, id_redes_s = ?, valores = ?, id_usuario = ? WHERE id_ins = ?";
        ...
        // read data
        $PDO->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "SELECT id_ins, nombre_ins , tel_ins , direccion_ins , correo_ins , objetivo_ins , mision_ins , vision_ins , principios_ins , director_ins ,id_redes_s , valores , id_usuario  FROM institucion WHERE id_ins =? ";
        $stmt = $PDO->prepare($sql);
        ...
        $nombre_ins = $data['nombre_ins'];
        $tel_ins = $data['tel_ins'];
        $direccion_ins = $data['direccion_ins'];
        $correo_ins = $data['correo_ins'];
        $objetivo_ins = $data['objetivo_ins'];
        $mision_ins = $data['mision_ins'];
        $vision_ins = $data['vision_ins'];
        $principios_ins = $data['principios_ins'];
        $director_ins = $data['director_ins'];
        $id_redes_s = $data['id_redes_s'];
    ...
    <div class='row'>
        ...
        <form method='POST'>
           <div class='form-group <?php print(!empty($nombre_insError)?"has-error":""); ?>'>
                ...
                <input type='text' name='nombre_ins' placeholder='nombre_ins' required='required' id='nombre_ins' class='form-control' value='<?php print($nombre_ins); ?>'>
            ...
            <div class='form-group <?php print(!empty($tel_insError)?"has-error":""); ?>'>
                ...
                <input type='text' name='tel_ins' placeholder='tel_ins' pattern="^[7|6]\d{7}$" min="1" max="9999999" maxlength="8" minlength="8" required='required' id='tel_ins' class='form-control' value='<?php print($tel_ins); ?>'>
            ...
            <div class='form-group <?php print(!empty($direccion_insError)?"has-error":""); ?>'>
                ...
                <input type='text' name='direccion_ins' placeholder='direccion_ins' required='required' id='direccion_ins' class='form-control' value='<?php print($director_ins); ?>'>
            ...
            <div class='form-group <?php print(!empty($correo_insError)?"has-error":""); ?>'>
                ...
                <input type='mail' name='correo_ins' placeholder='correo_ins' required='required' id='correo_ins' class='form-control' value='<?php print($correo_ins); ?>'>
             ...
             <div class='form-group <?php print(!empty($objetivo_insError)?"has-error":""); ?>'>
                ...
                <input type='text' name='objetivo_ins' placeholder='objetivo_ins' pattern="[a-zA-Z]*" required='required' id='objetivo_ins' class='form-control' value='<?php print($objetivo_ins); ?>'>
            ...
            <div class='form-group <?php print(!empty($mision_insError)?"has-error":""); ?>'>
                ...
                <input type='text' name='mision_ins' placeholder='mision_ins' pattern="[a-zA-Z]*" required='required' id='mision_ins' class='form-control' value='<?php print($mision_ins); ?>'>
             ...
             <div class='form-group <?php print(!empty($vision_insError)?"has-error":""); ?>'>
                ...
                <input type='text' name='vision_ins' placeholder='vision_ins' pattern="[a-zA-Z]*" required='required' id='vision_ins' class='form-control' value='<?php print($vision_ins); ?>'>
            ...
            <div class='form-group <?php print(!empty($principios_insError)?"has-error":""); ?>'>
                ...
                <input type='text' name='principios_ins' placeholder='principios_ins' pattern="[a-zA-Z]*" required='required' id='principios_ins' class='form-control' value='<?php print($principios_ins); ?>'>
            ...
            <div class='form-group <?php print(!empty($director_insError )?"has-error":""); ?>'>
                ...
                <input type='text' name='director_ins' placeholder='director_ins' pattern="[a-zA-Z]*" required='required' id='director_ins' class='form-control' value='<?php print($director_ins); ?>'>
           ...
           <div class='form-group <?php print(!empty($valoresError)?"has-error":""); ?>'>
                ...
                <input type='text' name='valores' placeholder='valores'  pattern="[a-zA-Z]*" required='required' id='valores' class='form-control' value='<?php print($valores); ?>'>
