        ...
        <table class='table table-striped table-bordered table-hover'>
            ...
            <?php
                ...
                foreach($PDO->query($sql) as $row) {
                    ...
                    $data .= "<td>";
                    $data .= "<a class='btn btn-xs btn-info' href='read.php?id=$row[id_usuario]'>Consultar</a>&nbsp;";
                    $data .= "<a class='btn btn-xs btn-primary' href='update.php?id=$row[id_usuario]'>Actualizar</a>&nbsp;";
                    $data .= "<a class='btn btn-xs btn-danger' href='delete.php?id=$row[id_usuario]'>Eliminar</a>";
                    $data .= "</td>";
                    $data .= "</tr>";
                }
                print($data);
